...
pub fn op_to_str(opcode: u32) -> Result<&'static str> {
    let out: &'static str = match opcode {
        ...
        5337 => "OpTraceNV",
        5338 => "OpTraceMotionNV",
        5339 => "OpTraceRayMotionNV",
        ...
        5600 => "OpConstantFunctionPointerINTEL",
        ...
        5911 => "OpAliasDomainDeclINTEL",
        5912 => "OpAliasScopeDeclINTEL",
        5913 => "OpAliasScopeListDeclINTEL",
